const cardArray6 = document.getElementById("card_clone_array6");
...
function newCardInside(group4, item4, content4) {
...
function cardInside(linkToPage, cardImg, redTitle, date, title, text) {
    const cardInside =  `<a href=${linkToPage} class="card">
...
newCardF1(cardArray6, cardInside, cardContent6)