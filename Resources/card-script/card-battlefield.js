const cardArray5 = document.getElementById("card_clone_array5");
...
function newCardBF(group4, item4, content4) {
...
function cardBF(linkToPage, cardImg, redTitle, date, title, text) {
    const card6 =  `<a href=${linkToPage} class="card">
...
newCardBF(cardArray5, cardBF, cardContentBF)